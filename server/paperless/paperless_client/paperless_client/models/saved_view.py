...
if TYPE_CHECKING:
    from ..models.saved_view_filter_rule import SavedViewFilterRule
...
class SavedView:
    ...
    Attributes:
        ...
        filter_rules (list[SavedViewFilterRule]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for filter_rules_item_data in _filter_rules:
            filter_rules_item = SavedViewFilterRule.from_dict(filter_rules_item_data)
