...
T = TypeVar("T", bound="PatchedApplicationConfigurationRequest")
...
class PatchedApplicationConfigurationRequest:
    ...
    user_args: Any | Unset = UNSET
    barcode_tag_mapping: Any | Unset = UNSET
    ...
    app_logo: File | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        app_logo: FileTypes | None | Unset
        if isinstance(self.app_logo, Unset):
            app_logo = UNSET
        elif isinstance(self.app_logo, File):
            app_logo = self.app_logo.to_tuple()
        ...
        field_dict.update({})
        if user_args is not UNSET:
            field_dict["user_args"] = user_args
        if barcode_tag_mapping is not UNSET:
            field_dict["barcode_tag_mapping"] = barcode_tag_mapping
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.user_args, Unset):
            files.append(("user_args", (None, str(self.user_args).encode(), "text/plain")))

        if not isinstance(self.barcode_tag_mapping, Unset):
            files.append(("barcode_tag_mapping", (None, str(self.barcode_tag_mapping).encode(), "text/plain")))

        if not isinstance(self.output_type, Unset):
            if isinstance(self.output_type, OutputTypeEnum):
                files.append(("output_type", (None, str(self.output_type.value).encode(), "text/plain")))
            elif isinstance(self.output_type, BlankEnum):
                files.append(("output_type", (None, str(self.output_type.value).encode(), "text/plain")))
            else:
                files.append(("output_type", (None, str(self.output_type).encode(), "text/plain")))

        if not isinstance(self.pages, Unset):
            if isinstance(self.pages, int):
                files.append(("pages", (None, str(self.pages).encode(), "text/plain")))
            else:
                files.append(("pages", (None, str(self.pages).encode(), "text/plain")))
        ...
        if not isinstance(self.mode, Unset):
            if isinstance(self.mode, ModeEnum):
        ...
        if not isinstance(self.skip_archive_file, Unset):
            if isinstance(self.skip_archive_file, SkipArchiveFileEnum):
                files.append(("skip_archive_file", (None, str(self.skip_archive_file.value).encode(), "text/plain")))
            elif isinstance(self.skip_archive_file, BlankEnum):
                files.append(("skip_archive_file", (None, str(self.skip_archive_file.value).encode(), "text/plain")))
            else:
                files.append(("skip_archive_file", (None, str(self.skip_archive_file).encode(), "text/plain")))

        if not isinstance(self.image_dpi, Unset):
            if isinstance(self.image_dpi, int):
                files.append(("image_dpi", (None, str(self.image_dpi).encode(), "text/plain")))
            else:
                files.append(("image_dpi", (None, str(self.image_dpi).encode(), "text/plain")))

        if not isinstance(self.unpaper_clean, Unset):
            if isinstance(self.unpaper_clean, UnpaperCleanEnum):
                files.append(("unpaper_clean", (None, str(self.unpaper_clean.value).encode(), "text/plain")))
            elif isinstance(self.unpaper_clean, BlankEnum):
                files.append(("unpaper_clean", (None, str(self.unpaper_clean.value).encode(), "text/plain")))
            else:
                files.append(("unpaper_clean", (None, str(self.unpaper_clean).encode(), "text/plain")))

        if not isinstance(self.deskew, Unset):
            if isinstance(self.deskew, bool):
                files.append(("deskew", (None, str(self.deskew).encode(), "text/plain")))
            else:
                files.append(("deskew", (None, str(self.deskew).encode(), "text/plain")))

        if not isinstance(self.rotate_pages, Unset):
            if isinstance(self.rotate_pages, bool):
                files.append(("rotate_pages", (None, str(self.rotate_pages).encode(), "text/plain")))
            else:
                files.append(("rotate_pages", (None, str(self.rotate_pages).encode(), "text/plain")))

        if not isinstance(self.rotate_pages_threshold, Unset):
            if isinstance(self.rotate_pages_threshold, float):
                files.append(
                    ("rotate_pages_threshold", (None, str(self.rotate_pages_threshold).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("rotate_pages_threshold", (None, str(self.rotate_pages_threshold).encode(), "text/plain"))
        ...
        if not isinstance(self.max_image_pixels, Unset):
            if isinstance(self.max_image_pixels, float):
                files.append(("max_image_pixels", (None, str(self.max_image_pixels).encode(), "text/plain")))
            else:
                files.append(("max_image_pixels", (None, str(self.max_image_pixels).encode(), "text/plain")))

        if not isinstance(self.color_conversion_strategy, Unset):
            if isinstance(self.color_conversion_strategy, ColorConversionStrategyEnum):
                files.append(
                    (
                        "color_conversion_strategy",
                        (None, str(self.color_conversion_strategy.value).encode(), "text/plain"),
                    )
                )
            elif isinstance(self.color_conversion_strategy, BlankEnum):
                files.append(
                ...
                files.append(
                    ("color_conversion_strategy", (None, str(self.color_conversion_strategy).encode(), "text/plain"))
                )

        if not isinstance(self.app_title, Unset):
            if isinstance(self.app_title, str):
                files.append(("app_title", (None, str(self.app_title).encode(), "text/plain")))
            else:
                files.append(("app_title", (None, str(self.app_title).encode(), "text/plain")))

        if not isinstance(self.app_logo, Unset):
            if isinstance(self.app_logo, File):
                files.append(("app_logo", self.app_logo.to_tuple()))
            else:
                files.append(("app_logo", (None, str(self.app_logo).encode(), "text/plain")))

        if not isinstance(self.barcodes_enabled, Unset):
            if isinstance(self.barcodes_enabled, bool):
                files.append(("barcodes_enabled", (None, str(self.barcodes_enabled).encode(), "text/plain")))
            else:
                files.append(("barcodes_enabled", (None, str(self.barcodes_enabled).encode(), "text/plain")))

        if not isinstance(self.barcode_enable_tiff_support, Unset):
            if isinstance(self.barcode_enable_tiff_support, bool):
                files.append(
                    (
                        "barcode_enable_tiff_support",
                        (None, str(self.barcode_enable_tiff_support).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
        ...
        if not isinstance(self.barcode_string, Unset):
            if isinstance(self.barcode_string, str):
                files.append(("barcode_string", (None, str(self.barcode_string).encode(), "text/plain")))
            else:
                files.append(("barcode_string", (None, str(self.barcode_string).encode(), "text/plain")))

        if not isinstance(self.barcode_retain_split_pages, Unset):
            if isinstance(self.barcode_retain_split_pages, bool):
                files.append(
                    ("barcode_retain_split_pages", (None, str(self.barcode_retain_split_pages).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("barcode_retain_split_pages", (None, str(self.barcode_retain_split_pages).encode(), "text/plain"))
        ...
        if not isinstance(self.barcode_enable_asn, Unset):
            if isinstance(self.barcode_enable_asn, bool):
                files.append(("barcode_enable_asn", (None, str(self.barcode_enable_asn).encode(), "text/plain")))
            else:
                files.append(("barcode_enable_asn", (None, str(self.barcode_enable_asn).encode(), "text/plain")))

        if not isinstance(self.barcode_asn_prefix, Unset):
            if isinstance(self.barcode_asn_prefix, str):
                files.append(("barcode_asn_prefix", (None, str(self.barcode_asn_prefix).encode(), "text/plain")))
            else:
                files.append(("barcode_asn_prefix", (None, str(self.barcode_asn_prefix).encode(), "text/plain")))

        if not isinstance(self.barcode_upscale, Unset):
            if isinstance(self.barcode_upscale, float):
                files.append(("barcode_upscale", (None, str(self.barcode_upscale).encode(), "text/plain")))
            else:
                files.append(("barcode_upscale", (None, str(self.barcode_upscale).encode(), "text/plain")))

        if not isinstance(self.barcode_dpi, Unset):
            if isinstance(self.barcode_dpi, int):
                files.append(("barcode_dpi", (None, str(self.barcode_dpi).encode(), "text/plain")))
            else:
                files.append(("barcode_dpi", (None, str(self.barcode_dpi).encode(), "text/plain")))

        if not isinstance(self.barcode_max_pages, Unset):
            if isinstance(self.barcode_max_pages, int):
                files.append(("barcode_max_pages", (None, str(self.barcode_max_pages).encode(), "text/plain")))
            else:
                files.append(("barcode_max_pages", (None, str(self.barcode_max_pages).encode(), "text/plain")))

        if not isinstance(self.barcode_enable_tag, Unset):
            if isinstance(self.barcode_enable_tag, bool):
                files.append(("barcode_enable_tag", (None, str(self.barcode_enable_tag).encode(), "text/plain")))
            else:
                files.append(("barcode_enable_tag", (None, str(self.barcode_enable_tag).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        user_args = d.pop("user_args", UNSET)

        barcode_tag_mapping = d.pop("barcode_tag_mapping", UNSET)
        ...
        def _parse_app_logo(data: object) -> File | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, bytes):
                    raise TypeError()
                app_logo_type_0 = File(payload=BytesIO(data))

                return app_logo_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
        ...
        patched_application_configuration_request = cls(
            user_args=user_args,
        ...
        patched_application_configuration_request.additional_properties = d
        return patched_application_configuration_request
