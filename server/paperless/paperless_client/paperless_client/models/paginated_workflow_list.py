...
T = TypeVar("T", bound="PaginatedWorkflowList")
...
class PaginatedWorkflowList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Workflow.from_dict(results_item_data)
        ...
        paginated_workflow_list.additional_properties = d
        return paginated_workflow_list
