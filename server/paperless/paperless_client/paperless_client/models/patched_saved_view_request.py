...
T = TypeVar("T", bound="PatchedSavedViewRequest")
...
class PatchedSavedViewRequest:
    ...
    Attributes:
        name (str | Unset):
        show_on_dashboard (bool | Unset):
        show_in_sidebar (bool | Unset):
        sort_field (None | str | Unset):
        sort_reverse (bool | Unset):
        filter_rules (list[SavedViewFilterRuleRequest] | Unset):
    ...
    show_on_dashboard: bool | Unset = UNSET
    show_in_sidebar: bool | Unset = UNSET
    sort_field: None | str | Unset = UNSET
    sort_reverse: bool | Unset = UNSET
    filter_rules: list[SavedViewFilterRuleRequest] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        filter_rules: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.filter_rules, Unset):
            filter_rules = []
        ...
        if show_on_dashboard is not UNSET:
            field_dict["show_on_dashboard"] = show_on_dashboard
        if show_in_sidebar is not UNSET:
            field_dict["show_in_sidebar"] = show_in_sidebar
        ...
        if filter_rules is not UNSET:
            field_dict["filter_rules"] = filter_rules
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.show_on_dashboard, Unset):
            files.append(("show_on_dashboard", (None, str(self.show_on_dashboard).encode(), "text/plain")))

        if not isinstance(self.show_in_sidebar, Unset):
        ...
        if not isinstance(self.filter_rules, Unset):
            for filter_rules_item_element in self.filter_rules:
                files.append(
                    (
                        "filter_rules",
                        (None, json.dumps(filter_rules_item_element.to_dict()).encode(), "application/json"),
                    )
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        show_on_dashboard = d.pop("show_on_dashboard", UNSET)

        show_in_sidebar = d.pop("show_in_sidebar", UNSET)
        ...
        _filter_rules = d.pop("filter_rules", UNSET)
        filter_rules: list[SavedViewFilterRuleRequest] | Unset = UNSET
        if _filter_rules is not UNSET:
            filter_rules = []
        ...
        patched_saved_view_request = cls(
            name=name,
        ...
        patched_saved_view_request.additional_properties = d
        return patched_saved_view_request
