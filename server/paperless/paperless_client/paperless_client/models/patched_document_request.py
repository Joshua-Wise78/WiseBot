...
if TYPE_CHECKING:
    ...
    from ..models.patched_document_request_set_permissions import PatchedDocumentRequestSetPermissions


T = TypeVar("T", bound="PatchedDocumentRequest")
...
class PatchedDocumentRequest:
    ...
    Attributes:
        ...
        set_permissions (PatchedDocumentRequestSetPermissions | Unset):
    ...
    set_permissions: PatchedDocumentRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = PatchedDocumentRequestSetPermissions.from_dict(_set_permissions)
        ...
        patched_document_request.additional_properties = d
        return patched_document_request
