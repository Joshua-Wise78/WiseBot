...
T = TypeVar("T", bound="PaginatedProcessedMailList")


@_attrs_define
class PaginatedProcessedMailList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ProcessedMail]):
        ...
        all_ (list[int] | Unset):  Example: [1, 2, 3].
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProcessedMail.from_dict(results_item_data)
        ...
        all_ = cast(list[int], d.pop("all", UNSET))

        paginated_processed_mail_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_processed_mail_list.additional_properties = d
        return paginated_processed_mail_list
