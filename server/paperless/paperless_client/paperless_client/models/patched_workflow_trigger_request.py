...
T = TypeVar("T", bound="PatchedWorkflowTriggerRequest")
...
class PatchedWorkflowTriggerRequest:
    ...
    Attributes:
        ...
        type_ (WorkflowTriggerTypeEnum | Unset): * `1` - Consumption Started
            * `2` - Document Added
            * `3` - Document Updated
            * `4` - Scheduled
    ...
    type_: WorkflowTriggerTypeEnum | Unset = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.sources, Unset):
            for sources_item_element in self.sources:
                files.append(("sources", (None, str(sources_item_element.value).encode(), "text/plain")))

        if not isinstance(self.type_, Unset):
            files.append(("type", (None, str(self.type_.value).encode(), "text/plain")))

        if not isinstance(self.filter_path, Unset):
            if isinstance(self.filter_path, str):
                files.append(("filter_path", (None, str(self.filter_path).encode(), "text/plain")))
            else:
                files.append(("filter_path", (None, str(self.filter_path).encode(), "text/plain")))

        if not isinstance(self.filter_filename, Unset):
            if isinstance(self.filter_filename, str):
                files.append(("filter_filename", (None, str(self.filter_filename).encode(), "text/plain")))
            else:
                files.append(("filter_filename", (None, str(self.filter_filename).encode(), "text/plain")))

        if not isinstance(self.filter_mailrule, Unset):
            if isinstance(self.filter_mailrule, int):
                files.append(("filter_mailrule", (None, str(self.filter_mailrule).encode(), "text/plain")))
            else:
                files.append(("filter_mailrule", (None, str(self.filter_mailrule).encode(), "text/plain")))
        ...
        if not isinstance(self.filter_has_tags, Unset):
            for filter_has_tags_item_element in self.filter_has_tags:
                files.append(("filter_has_tags", (None, str(filter_has_tags_item_element).encode(), "text/plain")))

        if not isinstance(self.filter_has_all_tags, Unset):
            for filter_has_all_tags_item_element in self.filter_has_all_tags:
                files.append(
                    ("filter_has_all_tags", (None, str(filter_has_all_tags_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.filter_has_not_tags, Unset):
            for filter_has_not_tags_item_element in self.filter_has_not_tags:
                files.append(
                    ("filter_has_not_tags", (None, str(filter_has_not_tags_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.filter_custom_field_query, Unset):
            if isinstance(self.filter_custom_field_query, str):
                files.append(
                    ("filter_custom_field_query", (None, str(self.filter_custom_field_query).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("filter_custom_field_query", (None, str(self.filter_custom_field_query).encode(), "text/plain"))
        ...
        if not isinstance(self.filter_has_not_correspondents, Unset):
            for filter_has_not_correspondents_item_element in self.filter_has_not_correspondents:
                files.append(
                    (
                        "filter_has_not_correspondents",
                        (None, str(filter_has_not_correspondents_item_element).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.filter_has_not_document_types, Unset):
            for filter_has_not_document_types_item_element in self.filter_has_not_document_types:
                files.append(
                    (
                        "filter_has_not_document_types",
                        (None, str(filter_has_not_document_types_item_element).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.filter_has_not_storage_paths, Unset):
            for filter_has_not_storage_paths_item_element in self.filter_has_not_storage_paths:
                files.append(
                    (
                        "filter_has_not_storage_paths",
                        (None, str(filter_has_not_storage_paths_item_element).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.filter_has_correspondent, Unset):
            if isinstance(self.filter_has_correspondent, int):
                files.append(
                    ("filter_has_correspondent", (None, str(self.filter_has_correspondent).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("filter_has_correspondent", (None, str(self.filter_has_correspondent).encode(), "text/plain"))
        ...
        if not isinstance(self.filter_has_document_type, Unset):
            if isinstance(self.filter_has_document_type, int):
                files.append(
                    ("filter_has_document_type", (None, str(self.filter_has_document_type).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("filter_has_document_type", (None, str(self.filter_has_document_type).encode(), "text/plain"))
        ...
        if not isinstance(self.filter_has_storage_path, Unset):
            if isinstance(self.filter_has_storage_path, int):
                files.append(
                    ("filter_has_storage_path", (None, str(self.filter_has_storage_path).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("filter_has_storage_path", (None, str(self.filter_has_storage_path).encode(), "text/plain"))
        ...
        if not isinstance(self.schedule_offset_days, Unset):
            files.append(("schedule_offset_days", (None, str(self.schedule_offset_days).encode(), "text/plain")))

        if not isinstance(self.schedule_is_recurring, Unset):
            files.append(("schedule_is_recurring", (None, str(self.schedule_is_recurring).encode(), "text/plain")))

        if not isinstance(self.schedule_recurring_interval_days, Unset):
            files.append(
                (
                    "schedule_recurring_interval_days",
                    (None, str(self.schedule_recurring_interval_days).encode(), "text/plain"),
                )
            )

        if not isinstance(self.schedule_date_field, Unset):
            files.append(("schedule_date_field", (None, str(self.schedule_date_field.value).encode(), "text/plain")))

        if not isinstance(self.schedule_date_custom_field, Unset):
            if isinstance(self.schedule_date_custom_field, int):
                files.append(
                    ("schedule_date_custom_field", (None, str(self.schedule_date_custom_field).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("schedule_date_custom_field", (None, str(self.schedule_date_custom_field).encode(), "text/plain"))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: WorkflowTriggerTypeEnum | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = WorkflowTriggerTypeEnum(_type_)
        ...
        patched_workflow_trigger_request = cls(
            id=id,
            sources=sources,
            type_=type_,
        ...
        patched_workflow_trigger_request.additional_properties = d
        return patched_workflow_trigger_request
