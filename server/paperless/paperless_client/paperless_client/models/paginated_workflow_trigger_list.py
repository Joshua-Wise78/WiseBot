...
T = TypeVar("T", bound="PaginatedWorkflowTriggerList")
...
class PaginatedWorkflowTriggerList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = WorkflowTrigger.from_dict(results_item_data)
        ...
        paginated_workflow_trigger_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_workflow_trigger_list.additional_properties = d
        return paginated_workflow_trigger_list
