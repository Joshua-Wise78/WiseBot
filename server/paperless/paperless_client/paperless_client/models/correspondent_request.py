...
if TYPE_CHECKING:
    from ..models.correspondent_request_set_permissions import CorrespondentRequestSetPermissions


T = TypeVar("T", bound="CorrespondentRequest")
...
class CorrespondentRequest:
    ...
    Attributes:
        ...
        set_permissions (CorrespondentRequestSetPermissions | Unset):
    """
    ...
    set_permissions: CorrespondentRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = CorrespondentRequestSetPermissions.from_dict(_set_permissions)

        correspondent_request = cls(
            name=name,
            match=match,
        ...
        correspondent_request.additional_properties = d
        return correspondent_request
