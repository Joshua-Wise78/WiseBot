...
T = TypeVar("T", bound="PaginatedStoragePathList")
...
class PaginatedStoragePathList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = StoragePath.from_dict(results_item_data)
        ...
        paginated_storage_path_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_storage_path_list.additional_properties = d
        return paginated_storage_path_list
