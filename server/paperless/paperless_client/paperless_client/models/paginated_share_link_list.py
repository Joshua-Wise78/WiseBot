...
T = TypeVar("T", bound="PaginatedShareLinkList")
...
class PaginatedShareLinkList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ShareLink.from_dict(results_item_data)
        ...
        paginated_share_link_list.additional_properties = d
        return paginated_share_link_list
