...
T = TypeVar("T", bound="PaginatedSavedViewList")
...
class PaginatedSavedViewList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SavedView.from_dict(results_item_data)
        ...
        paginated_saved_view_list.additional_properties = d
        return paginated_saved_view_list
