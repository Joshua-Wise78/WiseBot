...
T = TypeVar("T", bound="WorkflowActionWebhookRequest")
...
class WorkflowActionWebhookRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_action_webhook_request = cls(
            url=url,
            id=id,
        ...
        workflow_action_webhook_request.additional_properties = d
        return workflow_action_webhook_request
