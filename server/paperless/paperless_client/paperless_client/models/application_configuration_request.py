...
T = TypeVar("T", bound="ApplicationConfigurationRequest")
...
class ApplicationConfigurationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        application_configuration_request = cls(
            user_args=user_args,
            barcode_tag_mapping=barcode_tag_mapping,
        ...
        application_configuration_request.additional_properties = d
        return application_configuration_request
