...
if TYPE_CHECKING:
    from ..models.patched_tag_request_set_permissions import PatchedTagRequestSetPermissions
...
class PatchedTagRequest:
    ...
    Attributes:
        ...
        set_permissions (PatchedTagRequestSetPermissions | Unset):
    ...
    set_permissions: PatchedTagRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = PatchedTagRequestSetPermissions.from_dict(_set_permissions)
