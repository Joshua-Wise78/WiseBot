...
T = TypeVar("T", bound="PaginatedLogEntryList")
...
class PaginatedLogEntryList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LogEntry.from_dict(results_item_data)
        ...
        paginated_log_entry_list.additional_properties = d
        return paginated_log_entry_list
