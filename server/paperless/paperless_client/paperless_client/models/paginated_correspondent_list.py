...
T = TypeVar("T", bound="PaginatedCorrespondentList")
...
class PaginatedCorrespondentList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Correspondent.from_dict(results_item_data)
        ...
        paginated_correspondent_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_correspondent_list.additional_properties = d
        return paginated_correspondent_list
