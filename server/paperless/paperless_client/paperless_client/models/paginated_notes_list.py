...
T = TypeVar("T", bound="PaginatedNotesList")
...
class PaginatedNotesList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Notes.from_dict(results_item_data)
        ...
        paginated_notes_list.additional_properties = d
        return paginated_notes_list
