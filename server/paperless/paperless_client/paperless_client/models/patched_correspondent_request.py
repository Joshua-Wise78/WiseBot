...
if TYPE_CHECKING:
    from ..models.patched_correspondent_request_set_permissions import PatchedCorrespondentRequestSetPermissions


T = TypeVar("T", bound="PatchedCorrespondentRequest")
...
class PatchedCorrespondentRequest:
    ...
    Attributes:
        ...
        set_permissions (PatchedCorrespondentRequestSetPermissions | Unset):
    """
    ...
    set_permissions: PatchedCorrespondentRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = PatchedCorrespondentRequestSetPermissions.from_dict(_set_permissions)

        patched_correspondent_request = cls(
            name=name,
            match=match,
        ...
        patched_correspondent_request.additional_properties = d
        return patched_correspondent_request
