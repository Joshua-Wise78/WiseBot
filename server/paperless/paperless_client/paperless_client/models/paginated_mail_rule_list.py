...
T = TypeVar("T", bound="PaginatedMailRuleList")
...
class PaginatedMailRuleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MailRule.from_dict(results_item_data)
        ...
        paginated_mail_rule_list.additional_properties = d
        return paginated_mail_rule_list
