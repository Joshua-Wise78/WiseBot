...
T = TypeVar("T", bound="PaperlessAuthTokenRequest")
...
class PaperlessAuthTokenRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paperless_auth_token_request = cls(
            username=username,
            password=password,
            code=code,
        )

        paperless_auth_token_request.additional_properties = d
        return paperless_auth_token_request
