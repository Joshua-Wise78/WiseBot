...
if TYPE_CHECKING:
    from ..models.patched_mail_rule_request_set_permissions import PatchedMailRuleRequestSetPermissions


T = TypeVar("T", bound="PatchedMailRuleRequest")
...
class PatchedMailRuleRequest:
    ...
    Attributes:
        ...
        set_permissions (PatchedMailRuleRequestSetPermissions | Unset):
    """
    ...
    set_permissions: PatchedMailRuleRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = PatchedMailRuleRequestSetPermissions.from_dict(_set_permissions)

        patched_mail_rule_request = cls(
            name=name,
            account=account,
            enabled=enabled,
            folder=folder,
        ...
        patched_mail_rule_request.additional_properties = d
        return patched_mail_rule_request
