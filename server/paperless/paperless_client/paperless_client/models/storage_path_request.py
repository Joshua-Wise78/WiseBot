...
if TYPE_CHECKING:
    from ..models.storage_path_request_set_permissions import StoragePathRequestSetPermissions


T = TypeVar("T", bound="StoragePathRequest")
...
class StoragePathRequest:
    ...
    Attributes:
        ...
        set_permissions (StoragePathRequestSetPermissions | Unset):
    """
    ...
    set_permissions: StoragePathRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = StoragePathRequestSetPermissions.from_dict(_set_permissions)

        storage_path_request = cls(
            name=name,
            path=path,
            match=match,
        ...
        storage_path_request.additional_properties = d
        return storage_path_request
