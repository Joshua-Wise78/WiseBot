...
T = TypeVar("T", bound="WorkflowActionEmailRequest")
...
class WorkflowActionEmailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_action_email_request = cls(
            subject=subject,
            body=body,
            to=to,
            id=id,
        ...
        workflow_action_email_request.additional_properties = d
        return workflow_action_email_request
