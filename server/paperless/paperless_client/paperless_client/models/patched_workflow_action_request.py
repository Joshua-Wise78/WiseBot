...
if TYPE_CHECKING:
    from ..models.workflow_action_email_request import WorkflowActionEmailRequest
    from ..models.workflow_action_webhook_request import WorkflowActionWebhookRequest


T = TypeVar("T", bound="PatchedWorkflowActionRequest")
...
class PatchedWorkflowActionRequest:
    ...
    Attributes:
        ...
        email (None | Unset | WorkflowActionEmailRequest):
        webhook (None | Unset | WorkflowActionWebhookRequest):
    """
    ...
    email: None | Unset | WorkflowActionEmailRequest = UNSET
    webhook: None | Unset | WorkflowActionWebhookRequest = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.email, Unset):
            email = UNSET
        elif isinstance(self.email, WorkflowActionEmailRequest):
        ...
        if isinstance(self.webhook, Unset):
            webhook = UNSET
        elif isinstance(self.webhook, WorkflowActionWebhookRequest):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.assign_title, Unset):
            if isinstance(self.assign_title, str):
                files.append(("assign_title", (None, str(self.assign_title).encode(), "text/plain")))
            else:
                files.append(("assign_title", (None, str(self.assign_title).encode(), "text/plain")))
        ...
        if not isinstance(self.assign_storage_path, Unset):
            if isinstance(self.assign_storage_path, int):
                files.append(("assign_storage_path", (None, str(self.assign_storage_path).encode(), "text/plain")))
            else:
                files.append(("assign_storage_path", (None, str(self.assign_storage_path).encode(), "text/plain")))

        if not isinstance(self.assign_owner, Unset):
            if isinstance(self.assign_owner, int):
                files.append(("assign_owner", (None, str(self.assign_owner).encode(), "text/plain")))
            else:
                files.append(("assign_owner", (None, str(self.assign_owner).encode(), "text/plain")))

        if not isinstance(self.assign_view_users, Unset):
            for assign_view_users_item_element in self.assign_view_users:
                files.append(("assign_view_users", (None, str(assign_view_users_item_element).encode(), "text/plain")))

        if not isinstance(self.assign_view_groups, Unset):
            for assign_view_groups_item_element in self.assign_view_groups:
                files.append(
                    ("assign_view_groups", (None, str(assign_view_groups_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.assign_change_users, Unset):
            for assign_change_users_item_element in self.assign_change_users:
                files.append(
                    ("assign_change_users", (None, str(assign_change_users_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.assign_change_groups, Unset):
            for assign_change_groups_item_element in self.assign_change_groups:
                files.append(
                    ("assign_change_groups", (None, str(assign_change_groups_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.assign_custom_fields, Unset):
            for assign_custom_fields_item_element in self.assign_custom_fields:
                files.append(
                    ("assign_custom_fields", (None, str(assign_custom_fields_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.assign_custom_fields_values, Unset):
            files.append(
                ("assign_custom_fields_values", (None, str(self.assign_custom_fields_values).encode(), "text/plain"))
            )

        if not isinstance(self.remove_all_tags, Unset):
            files.append(("remove_all_tags", (None, str(self.remove_all_tags).encode(), "text/plain")))

        if not isinstance(self.remove_tags, Unset):
            for remove_tags_item_element in self.remove_tags:
                files.append(("remove_tags", (None, str(remove_tags_item_element).encode(), "text/plain")))

        if not isinstance(self.remove_all_correspondents, Unset):
            files.append(
                ("remove_all_correspondents", (None, str(self.remove_all_correspondents).encode(), "text/plain"))
            )

        if not isinstance(self.remove_correspondents, Unset):
            for remove_correspondents_item_element in self.remove_correspondents:
                files.append(
                    ("remove_correspondents", (None, str(remove_correspondents_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_all_document_types, Unset):
            files.append(
                ("remove_all_document_types", (None, str(self.remove_all_document_types).encode(), "text/plain"))
            )

        if not isinstance(self.remove_document_types, Unset):
            for remove_document_types_item_element in self.remove_document_types:
                files.append(
                    ("remove_document_types", (None, str(remove_document_types_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_all_storage_paths, Unset):
            files.append(
                ("remove_all_storage_paths", (None, str(self.remove_all_storage_paths).encode(), "text/plain"))
            )

        if not isinstance(self.remove_storage_paths, Unset):
            for remove_storage_paths_item_element in self.remove_storage_paths:
                files.append(
                    ("remove_storage_paths", (None, str(remove_storage_paths_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_custom_fields, Unset):
            for remove_custom_fields_item_element in self.remove_custom_fields:
                files.append(
                    ("remove_custom_fields", (None, str(remove_custom_fields_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_all_custom_fields, Unset):
            files.append(
                ("remove_all_custom_fields", (None, str(self.remove_all_custom_fields).encode(), "text/plain"))
            )

        if not isinstance(self.remove_all_owners, Unset):
            files.append(("remove_all_owners", (None, str(self.remove_all_owners).encode(), "text/plain")))

        if not isinstance(self.remove_owners, Unset):
            for remove_owners_item_element in self.remove_owners:
                files.append(("remove_owners", (None, str(remove_owners_item_element).encode(), "text/plain")))

        if not isinstance(self.remove_all_permissions, Unset):
            files.append(("remove_all_permissions", (None, str(self.remove_all_permissions).encode(), "text/plain")))

        if not isinstance(self.remove_view_users, Unset):
            for remove_view_users_item_element in self.remove_view_users:
                files.append(("remove_view_users", (None, str(remove_view_users_item_element).encode(), "text/plain")))

        if not isinstance(self.remove_view_groups, Unset):
            for remove_view_groups_item_element in self.remove_view_groups:
                files.append(
                    ("remove_view_groups", (None, str(remove_view_groups_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_change_users, Unset):
            for remove_change_users_item_element in self.remove_change_users:
                files.append(
                    ("remove_change_users", (None, str(remove_change_users_item_element).encode(), "text/plain"))
                )

        if not isinstance(self.remove_change_groups, Unset):
            for remove_change_groups_item_element in self.remove_change_groups:
                files.append(
                    ("remove_change_groups", (None, str(remove_change_groups_item_element).encode(), "text/plain"))
                )
        ...
        if not isinstance(self.email, Unset):
            if self.email is None:
                ...
                files.append(("email", (None, json.dumps(self.email.to_dict()).encode(), "application/json")))

        if not isinstance(self.webhook, Unset):
            if self.webhook is None:
                files.append(("webhook", (None, str(self.webhook).encode(), "text/plain")))
            else:
                files.append(("webhook", (None, json.dumps(self.webhook.to_dict()).encode(), "application/json")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_email(data: object) -> None | Unset | WorkflowActionEmailRequest:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                email_type_1 = WorkflowActionEmailRequest.from_dict(data)

                return email_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WorkflowActionEmailRequest, data)

        email = _parse_email(d.pop("email", UNSET))

        def _parse_webhook(data: object) -> None | Unset | WorkflowActionWebhookRequest:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                webhook_type_1 = WorkflowActionWebhookRequest.from_dict(data)

                return webhook_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WorkflowActionWebhookRequest, data)

        webhook = _parse_webhook(d.pop("webhook", UNSET))

        patched_workflow_action_request = cls(
            id=id,
            type_=type_,
        ...
        patched_workflow_action_request.additional_properties = d
        return patched_workflow_action_request
