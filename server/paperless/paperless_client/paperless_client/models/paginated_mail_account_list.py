...
T = TypeVar("T", bound="PaginatedMailAccountList")
...
class PaginatedMailAccountList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MailAccount.from_dict(results_item_data)
        ...
        paginated_mail_account_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mail_account_list.additional_properties = d
        return paginated_mail_account_list
