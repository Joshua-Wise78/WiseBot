...
T = TypeVar("T", bound="CorrespondentPermissionsView")
...
class CorrespondentPermissionsView:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        correspondent_permissions_view = cls(
            users=users,
            groups=groups,
        )

        correspondent_permissions_view.additional_properties = d
        return correspondent_permissions_view
