...
if TYPE_CHECKING:
    from ..models.document_type_request_set_permissions import DocumentTypeRequestSetPermissions


T = TypeVar("T", bound="DocumentTypeRequest")
...
class DocumentTypeRequest:
    ...
    Attributes:
        ...
        set_permissions (DocumentTypeRequestSetPermissions | Unset):
    """
    ...
    set_permissions: DocumentTypeRequestSetPermissions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_set_permissions, Unset):
            ...
            set_permissions = DocumentTypeRequestSetPermissions.from_dict(_set_permissions)

        document_type_request = cls(
            name=name,
            match=match,
        ...
        document_type_request.additional_properties = d
        return document_type_request
