...
from ...models.patched_saved_view_request import PatchedSavedViewRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedSavedViewRequest | PatchedSavedViewRequest | PatchedSavedViewRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/saved_views/{id}/".format(
            id=quote(str(id), safe=""),
        ),
    }

    if isinstance(body, PatchedSavedViewRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedSavedViewRequest | Unset):
        body (PatchedSavedViewRequest | Unset):
        body (PatchedSavedViewRequest | Unset):
