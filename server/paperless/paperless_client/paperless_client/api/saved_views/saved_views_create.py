...
from ...models.saved_view_request import SavedViewRequest
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: SavedViewRequest | SavedViewRequest | SavedViewRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, SavedViewRequest):
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> SavedView | None:
    if response.status_code == 201:
        response_201 = SavedView.from_dict(response.json())
