...
from ...models.paginated_document_type_list import PaginatedDocumentTypeList
...
) -> PaginatedDocumentTypeList | None:
    if response.status_code == 200:
        response_200 = PaginatedDocumentTypeList.from_dict(response.json())
