...
from ...models.patched_correspondent_request import PatchedCorrespondentRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedCorrespondentRequest | PatchedCorrespondentRequest | PatchedCorrespondentRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedCorrespondentRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedCorrespondentRequest | Unset):
        body (PatchedCorrespondentRequest | Unset):
        body (PatchedCorrespondentRequest | Unset):
