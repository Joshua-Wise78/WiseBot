...
from ...models.patched_document_request import PatchedDocumentRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedDocumentRequest | PatchedDocumentRequest | PatchedDocumentRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedDocumentRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedDocumentRequest | Unset): Adds update nested feature
        body (PatchedDocumentRequest | Unset): Adds update nested feature
        body (PatchedDocumentRequest | Unset): Adds update nested feature
