...
from ...models.patched_storage_path_request import PatchedStoragePathRequest
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedStoragePathRequest | PatchedStoragePathRequest | PatchedStoragePathRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedStoragePathRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedStoragePathRequest | Unset):
        body (PatchedStoragePathRequest | Unset):
        body (PatchedStoragePathRequest | Unset):
